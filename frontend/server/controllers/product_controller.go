...
func (this *ProductController) GetList() {
	...
	pageinfo := &PageInfo{count, indexpage, indexpage + 1, indexpage - 1, arrpages, endpage}
...
func (this *ProductController) GetDetail() {
	...
	productdetail := ProductDetail{IsLogin: IsLogin, Product: product}
	this.Data["json"] = productdetail
	this.ServeJSON()
	//this.Layout = "shared/productLayout.html"
